...
class WidgetExtensionDemo extends StatelessWidget {
  const WidgetExtensionDemo({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Padding and Centering Example',
            ...
            Text('Visibility and Opacity Example',
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            SizedBox(height: 8),
            Row(
              children: [
                Text('This text is visible')
                    ...
                    .opacity(0.8),
                SizedBox(width: 10),
                Text('Invisible Text => ').opacity(0.0),
                Text('This text is invisible').visibility(visible: false),
              ],
            ),
            SizedBox(height: 20),

            // Elevation and Material Example
            Text('Elevation and Material Example',
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            SizedBox(height: 8),
            Container(
              height: 100,
            ...
            Text('Responsive Constraint Example',
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            SizedBox(height: 8),
            Container(
              color: Colors.purple,
            ...
            Text('Rotation and Scaling Example',
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            SizedBox(height: 8),
            Container(
              color: Colors.red,
            ...
            Text('Materialized Widget with Border Radius Example',
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            SizedBox(height: 8),
            Container(
              height: 100,
            ...
            Text('Color Filter and Gradient Example',
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            SizedBox(height: 8),
          ],
        ),
